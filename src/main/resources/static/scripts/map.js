...
function getListItem(index, places) {
    ...
    itemStr += '<button class="btn btn-outline-danger p-2 mx-3" style="float:right" onclick="planInsert(\'' + places.place_name + '\',\'' + places.address_name + '\',\'' + places.id + '\',\'' + places.x + '\',\'' + places.y + '\')">' +
