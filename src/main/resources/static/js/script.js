...
jQuery(document).ready(function(){
	...
	var forgot_id_slide  = jQuery('.forgot-id-slide');
	...
	jQuery(document).on('click', '.login-form-slider .login-click', function() {
		...
		forgot_id_slide.velocity({translateX: '100%' }, {display:"none"});
	...
	jQuery(document).on('click', '.login-form-slider .forgot-id-click', function() {
		forgot_id_slide.velocity({translateX: ['0%','-100%'] }, {display:"block"});
		login_slide.velocity({translateX: '100%' }, {display:"none"});
	});
